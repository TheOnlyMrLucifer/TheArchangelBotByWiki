...
IMG = "https://telegra.ph/file/d8e85d25a6cc318c359cd.jpg"
...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@TheArchangelBot [@username] text`")
        description = "Usage: @TheArchangelBot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/TheArchangelBot?start=learn"
        )
...
@TheArchangelBot your whisper @username
...
example:- 
@TheArchangelBot hello this is a test @TheOnlyMrLucifer
