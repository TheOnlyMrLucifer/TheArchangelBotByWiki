...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@BadBSiBot[@username] text`")
        description = "Usage: @BadBSiBot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/BadBSiBot?start=learn"
        )
...
@BadBSiBot your whisper @username
...
example:- 
@BadBSiBot hello this is a test
